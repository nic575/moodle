...
$CFG->dbname    = 'insuran3_moodle';     // database name, eg moodle
$CFG->dbuser    = 'insuran3_qiktrading';   // your database username
$CFG->dbpass    = '9(oO8*iI7&uU';   // your database password
...
$CFG->wwwroot   = 'https://training.insuranceportal.co.za';
