...
<<<<<<< OURS
$string['accessnoticesheader'] = 'You can preview this assessment, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have assessmentzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the assessment. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the assessment. This means that different students are likely to get a different selection of questions, and when an assessment allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any assessment in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your assessment over on the other side of this page.</p>';
...
$string['addquestionstoquiz'] = 'Add questions to current assessment';
...
$string['addrandomquestiontoquiz'] = 'Add a random question to assessment {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstoquiz'] = 'Add selected questions to the assessment';
$string['addselectedtoquiz'] = 'Add selected to assessment';
$string['addtoquiz'] = 'Add to assessment';
...
$string['attempterror'] = 'You are not allowed to attempt this assessment at this time because: {$a}';
$string['attempterrorinvalid'] = 'Invalid assessment attempt ID';
$string['attempterrorcontentchange'] = 'This assessment preview no longer exists. (When an assessment is edited, any in-progress previews are automatically deleted.)';
$string['attempterrorcontentchangeforuser'] = 'This assessment attempt no longer exists.';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptquiznow'] = 'Attempt assessment now';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during assessment attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtoquiz'] = 'Back to assessment editing';
$string['basicideasofquiz'] = 'The basic ideas of assessment-making';
...
* The assessment will only start if the student has a JavaScript-enabled web-browser
* The assessment appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this assessment has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the assessment';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this assessment. The assessment is set to be graded out of {$a->grade}, but none of the questions in the assessment have a grade. This can be fixed on the \'Edit assessment\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this assessment. The assessment definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this assessment. The assessment has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, when a student has finished attempting a question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire assessment attempt and start another attempt. This option is useful for practice assessmentzes.
...
$string['canredoquestions_help'] = 'If enabled, when a student has finished attempting a question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire assessment attempt and start another attempt. This option is useful for practice assessmentzes.
...
$string['closebeforeopen'] = 'Could not update the assessment. You have specified a close date before the open date.';
...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the assessment settings) or higher.';
...
$string['completionattemptsexhausted_help'] = 'Mark assessment complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the assessment.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the assessment.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the assessment.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt an assessment after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the assessment.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new assessment. You can also configure which assessment settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the assessment grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the assessment page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the assessment editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during assessment attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the assessment.';
$string['configrequiresubnet'] = 'Students can only attempt the assessment from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review an assessment attempt or look at the assessment reports.';
$string['configshowblocks'] = 'Show blocks during assessment attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this assessment, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for assessmentzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for assessmentzes in seconds. 0 mean no time limit.';
...
$string['countdownfinished'] = 'The assessment is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The assessment will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to assessment';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the assessment.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the assessment a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the assessment a second time.';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new assessment attempt will contain the results of the previous attempt. This allows an assessment to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingquiz'] = 'Editing assessment';
$string['editingquiz_help'] = 'When creating an assessment, the main concepts are:

* The assessment, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the assessment and different students can get different questions';
$string['editingquiz_link'] = 'mod/quiz/edit';
$string['editingquizx'] = 'Editing assessment: {$a}';
...
$string['editquiz'] = 'Edit assessment';
$string['editquizquestions'] = 'Edit assessment questions';
...
You can access this assessment at {$a->quizurl}.';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the assessment. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the assessment when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the assessment. You have to make a trade-off based on how much you trust the performance of your server during assessmentzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final assessment grade:
...
$string['gradetopassnotset'] = 'This assessment does not yet have a grade to pass set. It may be set in the Grade section of the assessment settings.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this assessment has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt assessmentzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in an assessment.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the assessment';
$string['incorrect'] = 'Incorrect';
$string['indicator:cognitivedepth'] = 'Quiz cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in an assessment activity.';
$string['indicator:cognitivedepthdef'] = 'Quiz cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the assessment activities during this analysis interval (Levels = No view, View, Submit, View feedback, Comment on feedback, Resubmit after viewing feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'Quiz social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in an assessment activity.';
$string['indicator:socialbreadthdef'] = 'Quiz social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the assessment activities during this analysis interval (Levels = No participation, Participant alone, Participant with others)';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new assessment, provide this many blank overall feedback boxes. Once the assessment has been created, the form shows the number of fields required for the number of feedbacks in the assessment. The setting must be at least 1.';
...
$string['invalidquizid'] = 'Invalid assessment ID';
...
$string['legacyquizaccessrulescron'] = 'Legacy cron assessment access rules';
$string['legacyquizreportscron'] = 'Legacy cron assessment reports';
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in assessment';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your assessment attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own assessment submissions';
$string['messageprovider:submission'] = 'Notification of assessment submissions';
$string['max'] = 'Max';
...
$string['modulename_help'] = 'The assessment activity enables a teacher to create assessmentzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the assessment to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the assessment in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the assessment';
$string['newcategory'] = 'New category';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer assessmentzes it makes sense to stretch the assessment over several pages by limiting the number of questions per page. When adding questions to the assessment, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['nogradewarning'] = 'This assessment is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the assessment settings.';
...
$string['noquestionsinquiz'] = 'There are no questions in this assessment.';
...
$string['noreview'] = 'You are not allowed to review this assessment';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this assessment until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This assessment is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the assessment module. As a work around, set a time limit for the whole assessment. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this assessment';
...
$string['openafterclose'] = 'Could not update the assessment. You have specified an open date after the close date.';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after an assessment has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the assessment before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if a student fails to submit their assessment attempt before the time expires. If the student is actively working on the assessment at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this assessment to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['pageshort'] = 'P';
$string['page-mod-quiz-x'] = 'Any assessment module page';
$string['page-mod-quiz-attempt'] = 'Attempt assessment page';
$string['page-mod-quiz-edit'] = 'Edit assessment page';
$string['page-mod-quiz-report'] = 'Any assessment report page';
$string['page-mod-quiz-review'] = 'Review assessment attempt page';
...
$string['popup'] = 'Show assessment in a \'secure\' window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the assessment in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this assessment in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewquiz'] = 'Preview {$a}';
$string['previewquiznow'] = 'Preview assessment now';
$string['previous'] = 'Previous state';
$string['privacy:metadata:core_question'] = 'The assessment activity stores question usage information in the core_question subsystem.';
$string['privacy:metadata:quiz'] = 'The assessment activity makes use of assessment reports.';
$string['privacy:metadata:quiz_attempts'] = 'Details about each attempt on an assessment.';
...
$string['privacy:metadata:quiz_attempts:preview'] = 'Whether this is a preview of the assessment.';
...
$string['privacy:metadata:quiz_grades'] = 'Details about the overall grade for this assessment.';
$string['privacy:metadata:quiz_grades:grade'] = 'The overall grade for this assessment.';
$string['privacy:metadata:quiz_grades:quiz'] = 'The assessment that was graded.';
...
$string['privacy:metadata:quiz_overrides'] = 'Details about overrides for this assessment';
$string['privacy:metadata:quiz_overrides:quiz'] = 'The assessment with override information';
$string['privacy:metadata:quiz_overrides:timeclose'] = 'The new close time for the assessment.';
$string['privacy:metadata:quiz_overrides:timelimit'] = 'The new time limit for the assessment.';
$string['privacy:metadata:quiz_overrides:timeopen'] = 'The new open time for the assessment.';
$string['privacy:metadata:quiz_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:quizaccess'] = 'The assessment activity makes use of assessment access rules.';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->quiznames}<br />The question will not be deleted from these assessmentzes but only from the category list.';
...
$string['questionsinthisquiz'] = 'Questions in this assessment';
...
$string['quiz:addinstance'] = 'Add a new assessment';
$string['quiz:attempt'] = 'Attempt assessmentzes';
$string['quizavailable'] = 'The assessment is available until: {$a}';
$string['quizclose'] = 'Close the assessment';
$string['quizclosed'] = 'This assessment closed on {$a}';
$string['quizcloses'] = 'Quiz closes';
$string['quizeventcloses'] = '{$a} closes';
$string['quizcloseson'] = 'This assessment will close on {$a}.';
$string['quiz:deleteattempts'] = 'Delete assessment attempts';
...
$string['quiz:grade'] = 'Grade assessmentzes manually';
$string['quiz:ignoretimelimits'] = 'Ignore assessment time limit';
$string['quizisclosed'] = 'This assessment is closed';
$string['quizisopen'] = 'This assessment is open';
$string['quizisclosedwillopen'] = 'Quiz closed (opens {$a})';
$string['quizisopenwillclose'] = 'Quiz open (closes {$a})';
$string['quiz:manage'] = 'Manage assessmentzes';
$string['quiz:manageoverrides'] = 'Manage assessment overrides';
$string['quiznavigation'] = 'Quiz navigation';
$string['quizopen'] = 'Open the assessment';
...
$string['quizopened'] = 'This assessment is open.';
$string['quizopenedon'] = 'This assessment opened at {$a}';
$string['quizopens'] = 'Quiz opens';
$string['quizopenwillclose'] = 'This assessment is open, will close on {$a} at';
$string['quizordernotrandom'] = 'Order of assessment not shuffled';
$string['quizorderrandom'] = '* Order of assessment is shuffled';
$string['quiz:preview'] = 'Preview assessmentzes';
$string['quiz:regrade'] = 'Regrade assessment attempts';
$string['quiz:reviewmyattempts'] = 'Review your own attempts';
$string['quizsettings'] = 'Quiz settings';
$string['quiz:view'] = 'View assessment information';
$string['quiz:viewreports'] = 'View assessment reports';
$string['quiztimer'] = 'Quiz Timer';
$string['quizwillopen'] = 'This assessment will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole assessment to be graded.  Are you sure you want to continue?';
$string['reattemptquiz'] = 'Re-attempt assessment';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this assessment';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingquiz'] = 'Regrading assessment "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallquizattempts'] = 'Delete all assessment attempts';
...
$string['reportusersall'] = 'all users who have attempted the assessment';
$string['reportuserswith'] = 'enrolled users who have attempted the assessment';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the assessment';
$string['reportuserswithout'] = 'enrolled users who have not attempted the assessment';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the assessment.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Quiz access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) assessment, to ensure that only people in a certain location can access the assessment.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to assessment defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after assessment is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while assessment is open';
$string['reviewclosed'] = 'After the assessment is closed';
...
$string['reviewopen'] = 'Later, while the assessment is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review an assessment attempt or look at the assessment reports.
...
**Later, while the assessment is still open** settings apply after this, and before the assessment close date.

**After the assessment is closed** settings apply after the assessment close date has passed. If the assessment does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current assessment attempt.';
...
$string['savequiz'] = 'Save this whole assessment';
...
$string['showblocks'] = 'Show blocks during assessment attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during assessment attempts';
...
$string['shufflequestions_help'] = 'If enabled, every time the assessment is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the assessment, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonquiz'] = 'Specified question is not on the specified assessment';
...
$string['subneterror'] = 'Sorry, this assessment has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this assessment.';
$string['subnetnotice'] = 'This assessment has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the assessment.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the assessment since you have not passed the time delay before attempting another assessment';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial assessment page and a countdown timer is displayed in the assessment navigation block.';
$string['timelimit_link'] = 'mod/quiz/timing';
$string['timelimitexeeded'] = 'Sorry! assessment time limit exceeded!';
...
$string['updateoverdueattemptstask'] = 'Updating overdue assessment attempts';
$string['updatesettings'] = 'Update assessment settings';
$string['updatequizslotswithrandomxofy'] = 'Updating assessment slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradesure'] = '<div>In particular the assessment module will perform an extensive change of the assessment tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingquizattempts'] = 'Upgrading assessment attempts: assessment {$a->done}/{$a->outof} (Quiz id {$a->info})';
$string['upgradingveryoldquizattempts'] = 'Upgrading very old assessment attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this assessment';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} assessment attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this assessment';
$string['yourfinalgradeis'] = 'Your final grade for this assessment is {$a}.';

// Deprecated since Moodle 3.8.
$string['numattemptsmade'] = '{$a} attempts made on this assessment';
=======
